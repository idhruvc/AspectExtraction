...
class StanfordNLP:
    ...
    def dobj(self, sentence):  # extract multi word adverb
        kalimat = self.nlp.word_tokenize(sentence)
        pola = self.nlp.dependency_parse(sentence)
    ...
    def adjcom(self, sentence):  # extract multi word adverb
        kalimat = self.nlp.word_tokenize(sentence)
        pola = self.nlp.dependency_parse(sentence)
        print(kalimat)
        print(pola)
    ...
    def compverb(self, sentence):  # extract multi word adverb
        kalimat = self.nlp.word_tokenize(sentence)
        pola = self.nlp.dependency_parse(sentence)
        polas = self.nlp.pos_tag(sentence)
        print(kalimat)
    ...
    def admof(self, sentence):  # extract multi word adverb
        kalimat = self.nlp.word_tokenize(sentence)
        pola = self.nlp.dependency_parse(sentence)
        polas = self.nlp.pos_tag(sentence)
        print(kalimat)
